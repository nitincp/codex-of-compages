# [M3-origin | src/agents/spec_advisor.py @ 48a5b37]
"""
...
Frozen for the M3 milestone — do not import from src.agents.
"""
...
from src.milestones.m3.frameworks.chain_of_thought import ChainOfThought
from src.milestones.m3.frameworks.composed import ComposedPrompt
from src.milestones.m3.frameworks.costar import COSTARPrompt
...
class SpecAdvisorAgent(BaseAgent[SpecAdvisorOutput]):
    ...
    M3: COSTAR + ChainOfThought — reasoning layer added over M2 baseline.
    """
